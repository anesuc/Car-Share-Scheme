			...
			<div class="row animate-box">
				<div class="col-md-12 text-center col-md-offset-2" style="margin-left: 0;">
                    ...
                    .'</div>';
                        ...
                        echo '<a href="book?type=Standard" class="btn btn-primary btn-outline btn-lg">Standard</a>'
                        .'<a href="book?type=People Mover" class="btn btn-primary btn-outline btn-lg">People Mover</a>'
                        .'<a href="book?type=Luxury" class="btn btn-primary btn-outline btn-lg">Luxury</a>';
                    }
