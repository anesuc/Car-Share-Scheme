			...
			<div class="row animate-box">
				<div class="col-md-8 text-center col-md-offset-2">
                    ...
                    .'</div>';
                        ...
                        echo '<a href="booking?type=Basic" class="btn btn-primary btn-outline btn-lg">Basic</a>'
                        .'<a href="booking?type=Average" class="btn btn-primary btn-outline btn-lg">Average</a>'
                        .'<a href="booking?type=Premium" class="btn btn-primary btn-outline btn-lg">Premium</a>';
                    }
